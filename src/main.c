...
/*   Updated: 2026/05/13 13:45:17 by fhanuise         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	render_roof(create_rgb(p->ceiling[0], p->ceiling[1], p->ceiling[2]), &c);
	render_floor(create_rgb(p->floor[0], p->floor[1], p->floor[2]), &c);
